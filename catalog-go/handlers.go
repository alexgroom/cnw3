...
func GetProducts(w http.ResponseWriter, r *http.Request){
	...
	if misbehave {
		...
		products := Products{
			...
			Product{ ItemId: "165954", Name: "Patagonia Refugio pack 28L", Description: "Made from 630-denier 100% nylon (50% recycled/50% high-tenacity) plain weave; lined with 200-denier 100% recycled polyester. ...", Price: 6.00},
			...
			Product{ ItemId: "444437", Name: "Nanobloc Universal Webcam Cover", Description: "NanoBloc Webcam Cover fits phone, laptop, desktop, Pc, MacBook Pro, iMac, ...", Price: 2.75},
		}
